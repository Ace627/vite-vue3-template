...
## 技术栈（版本较新，选型需注意兼容）
- Vite `^8.1.1`、Vue `^3.5.39`、TypeScript `~6.0.2`、vue-tsc `^3.3.5`、@vitejs/plugin-vue `^6.0.7`、@vue/tsconfig `^0.9.1`、@types/node `^24`、sass `^1.101.0`（dev，已装）、unocss `^66.7.5`（dev，已装，2026-07-20 集成）
